...
# Qtile and more packages installer
# qtile 	 -> windows manager
# feh 	 	 -> Images manager, wallpaper tool
...
# network-manager-applet -> Network tool
# volumeicon 	 -> Volumen icon for desktop
# xorg-xinit 	 -> Visual driver
# ranger 	 -> File manager and tool
# glib2		 -> low core library
